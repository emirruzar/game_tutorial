...
public class PlayerController : MonoBehaviour
{
    ...
    private void SetPlayerJumping()
    {
        ...
        _playerRigidbody.AddForce(transform.up * _jumpForce, ForceMode.Impulse);//Impulse ani güç uygular
    }
    ...
    {
        _jumpForce += force;
        Invoke(nameof(ResetJumpForse), duration);
    }

    private void ResetJumpForse()
    {
