...
public class SettingsUI : MonoBehaviour
{
    ...
    private Image _blackBackroundImage;

    private void Awake()
    {
        _blackBackroundImage = _blackBackroundObject.GetComponent<Image>();
    ...
    private void OnSettingsButtonClicked()
    {
        ...
        _blackBackroundImage.DOFade(0.8f, _animationDuration).SetEase(Ease.Linear);
    ...
    private void OnResumeButtonClicked()
    {
        ...
        _blackBackroundImage.DOFade(0f, _animationDuration).SetEase(Ease.Linear);
        _settingsPopupObject.transform.DOScale(0f, _animationDuration).SetEase(Ease.OutExpo).OnComplete(() =>
        {
            GameManager.Instance.ChangeGameState(GameState.Resume);
            _blackBackroundObject.SetActive(false);
